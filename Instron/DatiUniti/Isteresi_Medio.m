...
% === PARAMETRI COMUNI ===
% =========================================================================
tipo_prova  = 'medio';   % Tipologia sensore: 'lungo', 'medio' o 'corto'
L0          = 50;        % Lunghezza iniziale sensore (mm)
...
% Percorsi di base
base_el  = "C:\Users\gdira\OneDrive\Documents\Magistrale\Laboratorio\Instron\Voltaggio\Medio\";
base_mec = "C:\Users\gdira\OneDrive\Documents\Magistrale\Laboratorio\Instron\Forza_Deformazione\Medioisteresi.is_tcyclic_Exports\";
base_out = ".\Dati\";
...
for p = 1:num_prove
    ...
    file_el  = base_el  + sprintf("Medioisteresi%d.txt", cpm_current);
    file_mec = base_mec + sprintf("Medioisteresi_%d.csv", p);
    ...
    % Chiamata allineata alla firma a 13 parametri:
    % (tipo_prova in 7a posizione, R0_riferimento in 13a)
...
title(sprintf('Mean Hysteresis and Standard Deviation - Medium Sensor'), ...
