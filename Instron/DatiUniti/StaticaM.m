...
elenco_file = [
    "dati_medio_statica2.csv";
    "dati_medio_statica3.csv";
    "dati_medio_statica4.csv";
    "dati_medio_statica5.csv";
    "dati_medio_statica6.csv"
];
...
%%
L_tot = 50; % Lunghezza iniziale del sensore in mm
...
% === 5. PLOT CON AREA OMBREGGIATA ===
figure('Name','MEDIO - Sensore vs Strain')
hold on;
grid on;
...
xlim([0, 9.8])
ylabel('\DeltaR/R0 (%)'); % <--- Aggiunte le parentesi per estetica
