...
elenco_file = [
    "dati_corto_statica2.csv";
    "dati_corto_statica3.csv";
    "dati_corto_statica4.csv";
    "dati_corto_statica5.csv";
    "dati_corto_statica6.csv"
];
...
%%
L_tot = 30; % Lunghezza iniziale del sensore in mm
